...
import crol.client.base.font.FontData;
import crol.client.base.font.MsdfGlyph;
...
implements IMinecraft {
    ...
    public static class Builder {
        ...
        public Builder data(String dataFileName) {
            this.dataIdentifer = CrolClient.id("fonts/msdf/" + dataFileName + ".json");
            return this;
        }

        public Builder atlas(String atlasFileName) {
            this.atlasIdentifier = CrolClient.id("fonts/msdf/" + atlasFileName + ".png");
            return this;
        }
