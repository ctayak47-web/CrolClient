...
extends Module {
    ...
    private static final String PREFIX_TITLE = "Crol Visual";
    ...
    public void onLocalItemPickup(ItemStack stack, int amount) {
        ...
        MutableText message = Text.literal((String)"[Crol Visual]").formatted(Formatting.BLUE).append((Text)Text.literal((String)" » ").formatted(Formatting.WHITE)).append((Text)Text.literal((String)(donateItem ? PICKUP_DONATE_TEXT : PICKUP_TEXT)).formatted(Formatting.WHITE)).append((Text)stack.getName().copy());
