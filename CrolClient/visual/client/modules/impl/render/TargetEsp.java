...
import crol.client.utility.compat.LunarCompat;
...
extends Module {
    ...
    private static final Identifier RHOMBUS_TEX = CrolClient.id("hud/target.png");
    private static final Identifier GLOW_TEX = CrolClient.id("hud/glow.png");
    private static final Identifier VEX_TEX = CrolClient.id("hud/skull.png");
    private static final Identifier MARKER_TEX = CrolClient.id("hud/marker.png");
    private static final Identifier SUPER_RHOMBUS_TEX = CrolClient.id("hud/cacto.png");
    private static final Identifier FLOW_TEX = CrolClient.id("hud/flow.png");
    private static final Identifier MARKER_V2_TEX = CrolClient.id("hud/markerv2.png");
    private static final Identifier VERTUSHKA_TEX = CrolClient.id("hud/vertyxua.png");
    private static final Identifier CHAIN_TEX = CrolClient.id("hud/chain.png");
    ...
    private TargetEsp() {
        this.themeManager = CrolClient.getInstance().getThemeManager();
