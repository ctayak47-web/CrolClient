...
extends Module {
    ...
    private static final Identifier HEART_TEXTURE = CrolClient.id("hud/particles/heart.png");
    private static final Identifier THOR_TEXTURE = CrolClient.id("hud/particles/thor.png");
    private static final Identifier LIGHTNING_TEXTURE = CrolClient.id("hud/particles/lightning.png");
    private static final Identifier SNOW_TEXTURE = CrolClient.id("hud/particles/snowflake.png");
    private static final Identifier SNOW_NEW_TEXTURE = CrolClient.id("hud/particles/snownew1.png");
    private static final Identifier SNOW_BRICH_TEXTURE = CrolClient.id("hud/particles/snowbrich1.png");
    private static final Identifier SNOW_BLAST_TEXTURE = CrolClient.id("hud/particles/snowblast1.png");
    private static final Identifier SNOW_BAG_TEXTURE = CrolClient.id("hud/particles/snowbag1.png");
    private static final Identifier ORB_TEXTURE = CrolClient.id("hud/particles/orb.png");
    private static final Identifier CROWN_TEXTURE = CrolClient.id("hud/particles/crown.png");
    private static final Identifier DOLLAR_TEXTURE = CrolClient.id("hud/particles/dollar.png");
    private static final Identifier SKULL_TEXTURE = CrolClient.id("hud/particles/skull.png");
    private static final Identifier STAR_TEXTURE = CrolClient.id("hud/particles/star.png");
    private static final Identifier FIREFLY_TEXTURE = CrolClient.id("hud/particles/firefly.png");
    private static final Identifier BLOOM_TEXTURE = CrolClient.id("hud/particles/bloom.png");
