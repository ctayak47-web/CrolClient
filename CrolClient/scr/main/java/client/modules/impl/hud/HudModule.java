...
extends Module {
    ...
    protected Gradient getAccentGradient() {
        ...
        ColorRGBA base = CrolClient.getInstance().getThemeManager().getCurrentTheme().getColor();
    ...
    protected ColorRGBA getAccentColor() {
        ...
        return CrolClient.getInstance().getThemeManager().getCurrentTheme().getColor();
    }
    ...
    protected Theme getTheme() {
        return CrolClient.getInstance().getThemeManager().getCurrentTheme();
    }
    ...
    private void saveHudLayout() {
        CrolClient.getInstance().getConfigManager().saveConfig("current_config");
    }
