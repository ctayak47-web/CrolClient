...
extends Module {
    ...
    private static final Identifier ZALUPA_PARTICLE = CrolClient.id("hud/particles/thor.png");
    ...
    private final ColorSetting lineColor = new ColorSetting("Цвет линии", () -> CrolClient.getInstance().getThemeManager().getCurrentTheme().getColor());
