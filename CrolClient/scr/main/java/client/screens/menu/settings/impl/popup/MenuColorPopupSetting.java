...
extends MenuPopupSetting {
    ...
    public void render(UIContext ctx, float mouseX, float mouseY, float alphas, Theme theme) {
        ...
        DrawUtil.drawRoundedTexture(ctx.getMatrices(), CrolClient.id("icons/sliderhue.png"), colorX, colorY + colorHeight + padding, colorWidth, 4.0f, round, ColorRGBA.WHITE.mulAlpha(alphas));
        ...
        DrawUtil.drawRoundedTexture(ctx.getMatrices(), CrolClient.id("icons/slidertransparent.png"), colorX, colorY + colorHeight + padding + 6.0f + padding, colorWidth, 4.0f, round, ColorRGBA.WHITE.mulAlpha(alphas));
