...
package crol.client.utility.discord;
...
public final class DiscordRpcService {
    ...
    private static final String DETAILS_TEXT = "Crol Visual";
    ...
    private static final String LARGE_IMAGE_TEXT = "Crol Visual";
