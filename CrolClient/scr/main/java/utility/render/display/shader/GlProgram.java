...
import crol.client.utility.mixin.accessors.ShaderProgramAccessor;

public class GlProgram
implements IMinecraft {
    private static final List<Runnable> REGISTERED_PROGRAMS = new ArrayList<Runnable>();
    private static final GlUniform NO_OP_UNIFORM = new GlUniform("CrolClient$noop", 4, 16);
        ...
        REGISTERED_PROGRAMS.add(() -> {
            ...
            try {
                ...
                if (this.backingProgram == null) {
                    ...
                    System.err.println("[CrolClient] " + this.lastError);
                    return;
                }
                this.setup();
                this.ready = true;
                ...
                System.err.println("[CrolClient] Failed to initialize shader program " + String.valueOf(this.programKey) + ": " + e.getMessage());
                e.printStackTrace();
