...
public class GaussianFilter {
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        if (this.radius > 0.0f) {
            GaussianFilter.convolveAndTranspose(this.kernel, inPixels, outPixels, width, height, true, true, false, 1);
            GaussianFilter.convolveAndTranspose(this.kernel, outPixels, inPixels, height, width, true, false, true, 1);
        }
