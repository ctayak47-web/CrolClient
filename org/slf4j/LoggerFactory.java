...
public final class LoggerFactory {
    static final String CODES_PREFIX = "https:
    static final String NO_PROVIDERS_URL = "https:
    static final String IGNORED_BINDINGS_URL = "https:
    static final String MULTIPLE_BINDINGS_URL = "https:
    static final String VERSION_MISMATCH = "https:
    static final String SUBSTITUTE_LOGGER_URL = "https:
    static final String LOGGER_NAME_MISMATCH_URL = "https:
    static final String REPLAY_URL = "https:
    static final String UNSUCCESSFUL_INIT_URL = "https:
    static final String UNSUCCESSFUL_INIT_MSG = "org.slf4j.LoggerFactory in failed state. Original exception was thrown EARLIER. See also https:
