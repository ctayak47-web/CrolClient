package ru.crolclient.api.system.font;
...
import ru.crolclient.api.system.font.entry.DrawEntry;
import ru.crolclient.api.system.font.glyph.Glyph;
import ru.crolclient.api.system.font.glyph.GlyphMap;
...
import static ru.crolclient.common.util.math.MathUtil.floorNearestMulN;
import static ru.crolclient.common.util.other.StringUtil.randomString;
...
public class FontRenderer implements QuickImports {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("crolclient", "temp/" + randomString(32));
    }
}
