...
package ru.crolclient.implement.features.commands.argument;
...
import ru.crolclient.api.feature.command.datatypes.IDatatype;
import ru.crolclient.api.feature.command.datatypes.IDatatypeContext;
import ru.crolclient.api.feature.command.datatypes.IDatatypeFor;
import ru.crolclient.api.feature.command.datatypes.IDatatypePost;
import ru.crolclient.api.feature.command.exception.CommandException;
import ru.crolclient.api.feature.command.exception.CommandInvalidTypeException;
import ru.crolclient.api.feature.command.exception.CommandNotEnoughArgumentsException;
import ru.crolclient.api.feature.command.exception.CommandTooManyArgumentsException;
import ru.crolclient.api.feature.command.manager.ICommandManager;
