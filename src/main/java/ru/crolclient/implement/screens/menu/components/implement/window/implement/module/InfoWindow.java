...
import ru.crolclient.api.feature.module.setting.implement.TextSetting;
...
public class InfoWindow extends AbstractWindow {
    ...
    public static final BindSetting menuBind = new BindSetting("Menu Key", "Key to open menu")
    ...
    public InfoWindow() {
        settingRepository.setup(menuBind, darkBackground);
