...
extends Module {
    ...
    private static final Identifier SOUL_TEX = VurstVisual.id("hud/skull.png");
    private static final SoundEvent KILL_SOUND = SoundEvent.of((Identifier)VurstVisual.id("kill_effect.abmiss"));
