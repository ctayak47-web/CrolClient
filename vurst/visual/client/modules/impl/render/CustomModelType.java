...
public enum CustomModelType {
    CRAZY_RABBIT("Безумный кролик", VurstVisual.id("custom_models/rabbit.png"), ModelKey.RABBIT),
    WHITE_DEMON("Белый демон", VurstVisual.id("custom_models/whitedemon.png"), ModelKey.DEMON),
    RED_DEMON("Красный демон", VurstVisual.id("custom_models/reddemon.png"), ModelKey.DEMON),
    FREDDY_BEAR("Фредди медведь", VurstVisual.id("custom_models/freddy.png"), ModelKey.FREDDY),
    AMOGUS("Амогус", VurstVisual.id("custom_models/amogus.png"), ModelKey.AMOGUS);
