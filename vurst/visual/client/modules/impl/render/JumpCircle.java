...
extends Module {
    ...
    private static final Identifier TEXTURE_DEFAULT = VurstVisual.id("hud/jump_circle.png");
    private static final Identifier TEXTURE_JUMPS_V1 = VurstVisual.id("hud/circle.png");
    private static final Identifier TEXTURE_JUMPS_V2 = VurstVisual.id("hud/circle_2.png");
    private static final Identifier TEXTURE_JUMPS_V3 = VurstVisual.id("hud/circle_bold.png");
    private static final Identifier TEXTURE_JUMPS_V4 = VurstVisual.id("hud/hens.png");
    private static final Identifier TEXTURE_VURST_VISUAL = VurstVisual.id("hud/vurstvisual.png");
    ...
    private final ModeSetting.Value modeVurstVisual = this.mode.getValues().get(6);
    ...
    private Identifier getCurrentTexture() {
        ...
        if (this.mode.is(this.modeVurstVisual)) {
