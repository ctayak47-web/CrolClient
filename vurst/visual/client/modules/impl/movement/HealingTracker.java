...
extends Module {
    ...
    private static final Identifier BROKEN_TEX = VurstVisual.id("hud/healing/lowhp_broken.png");
    private static final Identifier FIRE_TEX = VurstVisual.id("hud/healing/lowhp_fire.png");
    private static final Identifier THREE_D_TEX = VurstVisual.id("hud/healing/lowhp_3d.png");
    private static final Identifier ALERT_TEX = VurstVisual.id("hud/healing/lowhp_alert.png");
