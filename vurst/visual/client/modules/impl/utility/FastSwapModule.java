...
public final class FastSwapModule {
    private static final String CATEGORY = "category.vurstvisual.fastswap";
    ...
    private SwapBind createBind(String id, Item item) {
        KeyBinding keyBinding = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding("key.vurstvisual.fastswap." + id, InputUtil.Type.KEYSYM, -1, CATEGORY));
