...
package vurst.visual.utility.input;
...
public final class KeybindManager {
    private static final String CATEGORY_KEY = "category.vurstvisual.controls";
    private static final String OPEN_CLICK_GUI_KEY = "key.vurstvisual.open_click_gui";
