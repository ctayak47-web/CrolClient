...
package vurst.visual.utility.render.level;
...
import vurst.visual.utility.render.display.shader.impl.BlockOutlineShaderProgram;

public final class BlockOutlineShaderRenderer
implements IMinecraft {
    private static final BlockOutlineShaderProgram PLASMA_PROGRAM = new BlockOutlineShaderProgram(VurstVisual.id("block_outline_plasma/data"));
    private static final BlockOutlineShaderProgram NEBULA_PROGRAM = new BlockOutlineShaderProgram(VurstVisual.id("block_outline_nebula/data"));
    private static final BlockOutlineShaderProgram STARFIELD_PROGRAM = new BlockOutlineShaderProgram(VurstVisual.id("block_outline_starfield/data"));
    private static final BlockOutlineShaderProgram COBWEB_PROGRAM = new BlockOutlineShaderProgram(VurstVisual.id("block_outline_cobweb/data"));
