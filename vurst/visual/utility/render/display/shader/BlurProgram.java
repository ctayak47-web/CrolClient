...
import vurst.visual.utility.render.display.shader.impl.KawaseBlurProgram;
...
implements IWindow {
    ...
    public void initShaders() {
        kawaseDownProgram = new KawaseBlurProgram(VurstVisual.id("kawase_down/data"));
        kawaseUpProgram = new KawaseBlurProgram(VurstVisual.id("kawase_up/data"));
    }
