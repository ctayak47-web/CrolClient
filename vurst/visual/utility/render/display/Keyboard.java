...
public enum Keyboard {
    ...
    private static final Map<Integer, Keyboard> BY_CODE;
    private static final Map<String, Keyboard> BY_NAME;
    ...
    public static String getKeyName(int keyCode) {
        return Keyboard.BY_CODE.getOrDefault((Object)Integer.valueOf((int)keyCode), (Keyboard)Keyboard.KEY_NONE).name;
    }

    public static int getKeyCode(String keyName) {
        return Keyboard.BY_NAME.getOrDefault((Object)keyName.toLowerCase(), (Keyboard)Keyboard.KEY_NONE).keyCode;
    }

    public static boolean isKeyDown(int keyCode) {
        return InputUtil.isKeyPressed((long)MinecraftClient.getInstance().getWindow().getHandle(), (int)keyCode);
    }

    @Generated
    private Keyboard(String name, int keyCode) {
        this.name = name;
        this.keyCode = keyCode;
    }

    static {
        BY_CODE = new HashMap<Integer, Keyboard>();
        BY_NAME = new HashMap<String, Keyboard>();
