...
package vurst.visual.utility.mixin;
...
public final class VurstMixinPlugin
implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        lunarClient = VurstMixinPlugin.isClassPresent("com.moonsworth.lunar.genesis.Genesis") || VurstMixinPlugin.isClassPresent("com.moonsworth.lunar.ichor.Ichor") || VurstMixinPlugin.isClassPresent("com.moonsworth.lunar.client.LunarClient") || VurstMixinPlugin.classPathLooksLikeLunar();
        labyClient = VurstMixinPlugin.isClassPresent("net.labymod.api.Laby") || VurstMixinPlugin.isClassPresent("net.labymod.main.LabyMod") || VurstMixinPlugin.classPathLooksLikeLaby();
    }
    ...
    private static boolean isClassPresent(String name) {
        try {
            Class.forName(name, false, VurstMixinPlugin.class.getClassLoader());
            return true;
        }
