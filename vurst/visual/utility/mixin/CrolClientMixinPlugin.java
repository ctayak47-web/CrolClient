package CrolClient.visual.utility.mixin;
...
public final class CrolClientMixinPlugin
implements IMixinConfigPlugin {
    private static final String MIXIN_PACKAGE = "CrolClient.visual.utility.mixin.";
    ...
    public void onLoad(String mixinPackage) {
        lunarClient = CrolClientMixinPlugin.isClassPresent("com.moonsworth.lunar.genesis.Genesis") || CrolClientMixinPlugin.isClassPresent("com.moonsworth.lunar.ichor.Ichor") || CrolClientMixinPlugin.isClassPresent("com.moonsworth.lunar.client.LunarClient") || CrolClientMixinPlugin.classPathLooksLikeLunar();
        labyClient = CrolClientMixinPlugin.isClassPresent("net.labymod.api.Laby") || CrolClientMixinPlugin.isClassPresent("net.labymod.main.LabyMod") || CrolClientMixinPlugin.classPathLooksLikeLaby();
    }
    ...
    private static boolean isClassPresent(String name) {
        try {
            Class.forName(name, false, CrolClientMixinPlugin.class.getClassLoader());
            return true;
        }
