...
package vurst.visual.base.animations.base;
...
public interface Easing {
    ...
    public static final Easing SINE_IN = (t, b, c, d) -> -c * (float)MathUtil.cos((double)(t / d) * 1.5707963267948966) + c + b;
    public static final Easing SINE_OUT = (t, b, c, d) -> c * (float)MathUtil.sin((double)(t / d) * 1.5707963267948966) + b;
    public static final Easing SINE_IN_OUT = (t, b, c, d) -> -c / 2.0f * ((float)MathUtil.cos(Math.PI * (double)t / (double)d) - 1.0f) + b;
    ...
    extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            return -(a * (float)Math.pow(2.0, 10.0f * (t -= 1.0f)) * (float)MathUtil.sin((double)(t * d - s) * (Math.PI * 2) / (double)p)) + b;
        }
    }
    ...
    extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            return a * (float)Math.pow(2.0, -10.0f * t) * (float)MathUtil.sin((double)(t * d - s) * (Math.PI * 2) / (double)p) + c + b;
        }
    }
    ...
    extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            if (t < 1.0f) {
                return -0.5f * (a * (float)Math.pow(2.0, 10.0f * (t -= 1.0f)) * (float)MathUtil.sin((double)(t * d - s) * (Math.PI * 2) / (double)p)) + b;
            }
            return a * (float)Math.pow(2.0, -10.0f * (t -= 1.0f)) * (float)MathUtil.sin((double)(t * d - s) * (Math.PI * 2) / (double)p) * 0.5f + c + b;
        }
    }
