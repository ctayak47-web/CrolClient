...
public abstract class Invoker {
    ...
    public final long invokeN3(CallContext ctx, long function, long n1, long n2, long n3, int objCount, Object o1, ObjectParameterStrategy s1, ObjectParameterInfo o1info) {
        ...
        if (objCount == 1) {
            if (s1.isDirect()) {
                throw Invoker.newInsufficientObjectCountError(objCount);
            }
            return Foreign.invokeN3O1(ctx.contextAddress, function, n1, n2, n3, s1.object(o1), s1.objectInfo(o1info), s1.offset(o1), s1.length(o1));
        }
        throw Invoker.newObjectCountError(objCount);
    ...
    private static final class SingletonHolder {
        private static final Invoker INSTANCE = Platform.getPlatform().addressSize() == 64 ? LP64.access$000() : ILP32.access$100();
    ...
    extends Invoker {
        ...
        static /* synthetic */ Invoker access$000() {
            return INSTANCE;
        }
    }
    ...
    extends Invoker {
        ...
        @Override
        public final long invokeAddress(CallContext ctx, long function, HeapInvocationBuffer buffer) {
            return (long)this.invokeInt(ctx, function, buffer) & 0xFFFFFFFFL;
        }
