...
final class Foreign {
    public static final int VERSION_MAJOR = Foreign.getVersionField("MAJOR");
    public static final int VERSION_MINOR = Foreign.getVersionField("MINOR");
    public static final int VERSION_MICRO = Foreign.getVersionField("MICRO");
    ...
    static boolean isMemoryProtectionEnabled() {
        try {
            return Foreign.isFaultProtectionEnabled();
        }
    ...
    private static abstract class InstanceHolder {
        static final InstanceHolder INSTANCE = InstanceHolder.getInstanceHolder();
        ...
        private static InstanceHolder getInstanceHolder() {
            try {
                ...
                if ((foreign.getVersion() & 0xFFFF00) != (VERSION_MAJOR << 16 | VERSION_MINOR << 8)) {
                    String msg = String.format("incorrect native library version %d.%d, expected %d.%d", foreign.getVersion() >> 16 & 0xFF, foreign.getVersion() >> 8 & 0xFF, VERSION_MAJOR, VERSION_MINOR);
    ...
    private static final class InValidInstanceHolder
    extends InstanceHolder {
    ...
    private static final class ValidInstanceHolder
    extends InstanceHolder {
