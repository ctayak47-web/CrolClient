...
public class LinuxFileStatSPARCV9
...
implements NanosecondFileStat {
    ...
    @Override
    public long atime() {
        return LinuxFileStatSPARCV9.layout.st_atime.get(this.memory);
    }

    @Override
    public long aTimeNanoSecs() {
        return LinuxFileStatSPARCV9.layout.st_atimensec.get(this.memory);
    }

    @Override
    public long blockSize() {
        return LinuxFileStatSPARCV9.layout.st_blksize.get(this.memory);
    }

    @Override
    public long blocks() {
        return LinuxFileStatSPARCV9.layout.st_blocks.get(this.memory);
    }

    @Override
    public long ctime() {
        return LinuxFileStatSPARCV9.layout.st_ctime.get(this.memory);
    }

    @Override
    public long cTimeNanoSecs() {
        return LinuxFileStatSPARCV9.layout.st_ctimensec.get(this.memory);
    }

    @Override
    public long dev() {
        return LinuxFileStatSPARCV9.layout.st_dev.get(this.memory);
    }

    @Override
    public int gid() {
        return (int)LinuxFileStatSPARCV9.layout.st_gid.get(this.memory);
    }

    @Override
    public long ino() {
        return LinuxFileStatSPARCV9.layout.st_ino.get(this.memory);
    }

    @Override
    public int mode() {
        return (int)LinuxFileStatSPARCV9.layout.st_mode.get(this.memory);
    }

    @Override
    public long mtime() {
        return LinuxFileStatSPARCV9.layout.st_mtime.get(this.memory);
    }

    @Override
    public long mTimeNanoSecs() {
        return LinuxFileStatSPARCV9.layout.st_mtimensec.get(this.memory);
    }

    @Override
    public int nlink() {
        return (int)LinuxFileStatSPARCV9.layout.st_nlink.get(this.memory);
    }

    @Override
    public long rdev() {
        return LinuxFileStatSPARCV9.layout.st_rdev.get(this.memory);
    }

    @Override
    public long st_size() {
        return LinuxFileStatSPARCV9.layout.st_size.get(this.memory);
    }

    @Override
    public int uid() {
        return (int)LinuxFileStatSPARCV9.layout.st_uid.get(this.memory);
    }

    public static final class Layout
    extends StructLayout {
        public final StructLayout.dev_t st_dev = new StructLayout.dev_t();
        public final StructLayout.Unsigned16 __pad1 = new StructLayout.Unsigned16();
        ...
        public final StructLayout.Unsigned16 __pad2 = new StructLayout.Unsigned16();
        ...
        public final StructLayout.Unsigned64 __unused4 = new StructLayout.Unsigned64();
        public final StructLayout.Unsigned64 __unused5 = new StructLayout.Unsigned64();
