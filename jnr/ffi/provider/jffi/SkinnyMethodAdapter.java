...
implements Opcodes {
    private static final boolean DEBUG = Boolean.getBoolean("jnr.ffi.compile.dump");
    ...
    public void aload(LocalVariable arg0) {
        this.getMethodVisitor().visitVarInsn(25, arg0.idx);
    }
    ...
    public void aload(LocalVariable ... args) {
        for (LocalVariable arg : args) {
            this.getMethodVisitor().visitVarInsn(25, arg.idx);
        }
    }
    ...
    public void iload(LocalVariable arg0) {
        this.getMethodVisitor().visitVarInsn(21, arg0.idx);
    }
    ...
    public void iload(LocalVariable ... args) {
        for (LocalVariable arg : args) {
            this.getMethodVisitor().visitVarInsn(21, arg.idx);
        }
    }
    ...
    public void lload(LocalVariable ... args) {
        for (LocalVariable arg : args) {
            this.getMethodVisitor().visitVarInsn(22, arg.idx);
        }
    }
    ...
    public void fload(LocalVariable arg0) {
        this.getMethodVisitor().visitVarInsn(23, arg0.idx);
    }
    ...
    public void dload(LocalVariable arg0) {
        this.getMethodVisitor().visitVarInsn(24, arg0.idx);
    }
    ...
    public void astore(LocalVariable arg0) {
        this.getMethodVisitor().visitVarInsn(58, arg0.idx);
    }
    ...
    public void istore(LocalVariable arg0) {
        this.getMethodVisitor().visitVarInsn(54, arg0.idx);
    }
    ...
    public void lstore(LocalVariable arg0) {
        this.getMethodVisitor().visitVarInsn(55, arg0.idx);
    }
    ...
    public void fstore(LocalVariable arg0) {
        this.getMethodVisitor().visitVarInsn(56, arg0.idx);
    }
    ...
    public void dstore(LocalVariable arg0) {
        this.getMethodVisitor().visitVarInsn(57, arg0.idx);
    }
    ...
    public void if_icmpge(Label arg0) {
        this.getMethodVisitor().visitJumpInsn(162, arg0);
    }
    ...
    public void checkcast(Class clazz) {
        this.getMethodVisitor().visitTypeInsn(192, CodegenUtils.p(clazz));
    }
    ...
    private void dump() {
        ...
        Class<?> tmvClass = this.getMethodVisitor().getClass();
        try {
            Method print = tmvClass.getDeclaredMethod("print", PrintWriter.class);
            pw.write("*** Dumping ***\n");
            print.invoke((Object)this.getMethodVisitor(), pw);
        }
    ...
    public void iinc(LocalVariable arg0, int arg1) {
        this.getMethodVisitor().visitIincInsn(arg0.idx, arg1);
    }
    ...
    public void visitAnnotationWithFields(String name, boolean visible, Map<String, Object> fields) {
        AnnotationVisitor visitor = this.visitAnnotation(name, visible);
    ...
    public void visitParameterAnnotationWithFields(int param, String name, boolean visible, Map<String, Object> fields) {
        AnnotationVisitor visitor = this.visitParameterAnnotation(param, name, visible);
        CodegenUtils.visitAnnotationFields(visitor, fields);
        visitor.visitEnd();
    }
