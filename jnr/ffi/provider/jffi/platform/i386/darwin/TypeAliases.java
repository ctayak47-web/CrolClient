...
public final class TypeAliases {
    public static final Map<TypeAlias, NativeType> ALIASES = TypeAliases.buildTypeMap();

    private static Map<TypeAlias, NativeType> buildTypeMap() {
        EnumMap<TypeAlias, NativeType> m = new EnumMap<TypeAlias, NativeType>(TypeAlias.class);
