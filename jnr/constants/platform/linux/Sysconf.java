...
public enum Sysconf implements Constant
{
    ...
    static final class StringTable {
        public static final Map<Sysconf, String> descriptions = StringTable.generateTable();

        StringTable() {
        }

        public static final Map<Sysconf, String> generateTable() {
            EnumMap<Sysconf, String> map = new EnumMap<Sysconf, String>(Sysconf.class);
